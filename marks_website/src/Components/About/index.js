  ...
  return (
    <div className='about'>
      ...
      <div className='about__desc'>
        <p>Hello and welcome to my profile! My name is Kiprop, I am a passionate junior software developer, with a strong foundation in computer science and a love for problem-solving.</p>
